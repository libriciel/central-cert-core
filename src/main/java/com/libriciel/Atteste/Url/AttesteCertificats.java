...
public class AttesteCertificats {
	...
	public void test() {
		...
		System.out.println(cr.saveAll(getCertificateFromURL("https://github.com/")));
		System.out.println(cr.saveAll(getCertificateFromURL("https://reversecoding.net/spring-mvc-requestparam-binding-request-parameters/")));
